...
from database import render_indisponibility_db_Motif
...
def predicting_exporting_Elnet_15min(interval_from, interval_to, limitation_percentage):
	...
	xgb_loaded = joblib.load("./Elnet/rs_xgb_elnet_prod_15min_0426.pkl")
...
def predicting_exporting_Dragosel_15min(interval_from, interval_to, limitation_percentage):
	...
	xgb_loaded = joblib.load("./Dragosel/rs_xgb_dragosel_prod_15min_0426.pkl")
...
def predicting_exporting_GESS_15min(interval_from, interval_to, limitation_percentage):
	...
	xgb_loaded = joblib.load("./GESS/rs_xgb_gess_prod_15min_0526.pkl")
...
def predicting_exporting_MM_MV_15min(interval_from, interval_to, limitation_percentage):
	...
	xgb_loaded = joblib.load("./MM_MV/rs_xgb_mm&mv_prod_15min_0526.pkl")
...
def predicting_exporting_Rosiori_15min(interval_from, interval_to, limitation_percentage):
	...
	xgb_loaded = joblib.load("./Rosiori/rs_xgb_rosiori_prod_15min_0526.pkl")
...
def predicting_exporting_Adrem_15min(interval_from, interval_to, limitation_percentage):
	...
	xgb_loaded = joblib.load("./Adrem/rs_xgb_adrem_prod_15min_0426.pkl")
...
def predicting_exporting_Anto_15min(interval_from, interval_to, limitation_percentage):
	...
	xgb_loaded = joblib.load("./Anto/rs_xgb_anto_prod_15min_0226.pkl")
...
def predicting_exporting_Ferma_15min(interval_from, interval_to, limitation_percentage):
	...
	xgb_loaded = joblib.load("./Ferma/rs_xgb_ferma_prod_15min_1225.pkl")
...
def render_production_forecast():
	...
	# Allow the user to choose between Consumption and Production
	PVPP = st.radio("Choose PVPP:", options=["Kahraman", "Astro", "Imperial", "SunEnergy", "SolarEnergy", "Elnet", "Horeco", "3D Steel", "Dragosel", "GESS", "NRG", "Sun Grow Lucia", "Photovoltaic Energy Project", "MM_MV", "Primaria Rosiori", "Necaluxan", "Adrem", "Anto", "Motif", "Ferma"], index=None)
