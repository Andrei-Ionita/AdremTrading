...
def predicting_exporting_SolarEnergy_15min(interval_from, interval_to, limitation_percentage):
	...
	# Load model
	xgb_loaded = joblib.load("./Solar Energy Ulmeni/rs_xgb_Ulmeni_prod_15min_0126.pkl")
...
def predicting_exporting_NRG_15min(interval_from, interval_to, limitation_percentage):
	...
	xgb_loaded = joblib.load("./NRG/rs_xgb_NRG_prod_15min_0126.pkl")
...
def predicting_exporting_Rosiori_15min(interval_from, interval_to, limitation_percentage):
	...
	xgb_loaded = joblib.load("./Rosiori/rs_xgb_rosiori_prod_15min_0226.pkl")
