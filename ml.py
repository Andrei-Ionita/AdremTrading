...
def predicting_exporting_SolarEnergy_15min(interval_from, interval_to, limitation_percentage):
	...
	# Load model
	xgb_loaded = joblib.load("./Solar Energy Ulmeni/rs_xgb_Ulmeni_prod_15min_1025.pkl")
...
def predicting_exporting_Dragosel_15min(interval_from, interval_to, limitation_percentage):
	...
	xgb_loaded = joblib.load("./Dragosel/rs_xgb_Dragosel_prod_15min_0625.pkl")
...
def render_production_forecast():
	...
	# Allow the user to choose between Consumption and Production
	PVPP = st.radio("Choose PVPP:", options=["Kahraman", "Astro", "Imperial", "SunEnergy", "SolarEnergy", "Elnet", "Horeco", "3D Steel", "Dragosel", "GESS", "NRG", "Sun Grow Lucia"], index=None)
