...
def predicting_exporting_Imperial_15min(interval_to, interval_from, limitation_percentage):
	...
	xgb_loaded = joblib.load("./Imperial/rs_xgb_imperial_prod_15min_0626.pkl")
...
def predicting_exporting_SolarEnergy_15min(interval_from, interval_to, limitation_percentage):
	...
	# Load model
	xgb_loaded = joblib.load("./Solar Energy Ulmeni/rs_xgb_ulmeni_prod_15min_0426.pkl")
...
def predicting_exporting_Horeco_15min(interval_from, interval_to, limitation_percentage):
	...
	xgb_loaded = joblib.load("./Horeco/rs_xgb_horeco_prod_15min_0426.pkl")
