...
def predicting_exporting_Elnet_15min(interval_from, interval_to, limitation_percentage):
	...
	xgb_loaded = joblib.load("./Elnet/rs_xgb_Elnet_prod_15min_0126.pkl")
...
def predicting_exporting_Sun_Grow_Lucia_15min(interval_from, interval_to, limitation_percentage):
	...
	xgb_loaded = joblib.load("./Sun_Grow_Lucia/rs_xgb_SunGrow_prod_15min_0226.pkl")
...
def render_production_forecast():
	...
	# Allow the user to choose between Consumption and Production
	PVPP = st.radio("Choose PVPP:", options=["Kahraman", "Astro", "Imperial", "SunEnergy", "SolarEnergy", "Elnet", "Horeco", "3D Steel", "Dragosel", "GESS", "NRG", "Sun Grow Lucia", "Photovoltaic Energy Project", "MM_MV", "Primaria Rosiori", "Necaluxan", "Adrem", "Anto"], index=None)
