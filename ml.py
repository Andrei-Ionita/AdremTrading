...
if 'solcast_api_key' not in st.session_state:
	try:
		solcast_api_key = st.secrets["solcast_api_key"]
	except:
		solcast_api_key = "7sEypbLW0NCaQvF1LBJPG5fN8vWHUQB_"
	st.session_state['solcast_api_key'] = solcast_api_key
...
def fetching_SunEnergy_data():
	...
	if response.status_code == 200:
		# Write the content to a CSV file
		with open("./PC SunEnergy/Solcast/Oltenita_raw.csv", 'wb') as file:
			file.write(response.content)
	else:
		print(response.text)  # Add this line to see the error message returned by the API
		raise Exception(f"Failed to fetch data: Status code {response.status_code}")
	# Adjusting the values to EET time
	data = pd.read_csv("./PC SunEnergy/Solcast/Oltenita_raw.csv")
	...
	# Save the adjusted DataFrame
	data_adjusted.to_csv("./PC SunEnergy/Solcast/Oltenita_raw.csv", index=False)

def fetching_SunEnergy_data_15min():
	lat = 44.086577
	lon = 26.638170
	# Fetch data from the API
	api_url = "https://api.solcast.com.au/data/forecast/radiation_and_weather?latitude={}&longitude={}&hours=168&output_parameters=air_temp,ghi,azimuth,cloud_opacity,dewpoint_temp,relative_humidity,zenith&period=PT15M&format=csv&time_zone=3&api_key={}".format(lat, lon, solcast_api_key)
	...
	if response.status_code == 200:
		# Write the content to a CSV file
		with open("./PC SunEnergy/Solcast/Oltenita_15min.csv", 'wb') as file:
			file.write(response.content)
	else:
		print(response.text)  # Add this line to see the error message returned by the API
		raise Exception(f"Failed to fetch data: Status code {response.status_code}")
...
def fetching_Elnet_data():
	...
	if response.status_code == 200:
		# Write the content to a CSV file
		with open("./Elnet/Solcast/Bucsani_raw.csv", 'wb') as file:
			file.write(response.content)
	else:
		print(response.text)  # Add this line to see the error message returned by the API
		raise Exception(f"Failed to fetch data: Status code {response.status_code}")
	# Adjusting the values to EET time
	data = pd.read_csv("./Elnet/Solcast/Bucsani_raw.csv")
	...
	# Save the adjusted DataFrame
	data_adjusted.to_csv("./Elnet/Solcast/Bucsani_raw.csv", index=False)

def fetching_Elnet_data_15min():
	lat = 44.376216
	lon = 25.672805
	# Fetch data from the API
	api_url = "https://api.solcast.com.au/data/forecast/radiation_and_weather?latitude={}&longitude={}&hours=168&output_parameters=air_temp,ghi,azimuth,cloud_opacity,dewpoint_temp,relative_humidity,zenith&period=PT15M&format=csv&time_zone=3&api_key={}".format(lat, lon, solcast_api_key)
	...
	if response.status_code == 200:
		# Write the content to a CSV file
		with open("./Elnet/Solcast/Bucsani_15min.csv", 'wb') as file:
			file.write(response.content)
	else:
		print(response.text)  # Add this line to see the error message returned by the API
		raise Exception(f"Failed to fetch data: Status code {response.status_code}")
	# Adjusting the values to EET time
	data = pd.read_csv("./Elnet/Solcast/Bucsani_15min.csv")

def fetching_Horeco_data():
	lat = 45.137111
	lon = 26.817112
	# Fetch data from the API
	api_url = "https://api.solcast.com.au/data/forecast/radiation_and_weather?latitude={}&longitude={}&hours=168&output_parameters=air_temp,ghi,azimuth,cloud_opacity,dewpoint_temp,relative_humidity,zenith&period=PT60M&format=csv&api_key={}".format(lat, lon, solcast_api_key)
	...
	if response.status_code == 200:
		# Write the content to a CSV file
		with open("./Horeco/Solcast/Buzau_raw.csv", 'wb') as file:
			file.write(response.content)
	else:
		print(response.text)  # Add this line to see the error message returned by the API
		raise Exception(f"Failed to fetch data: Status code {response.status_code}")
	# Adjusting the values to EET time
	data = pd.read_csv("./Horeco/Solcast/Buzau_raw.csv")
	...
	# Save the adjusted DataFrame
	data_adjusted.to_csv("./Horeco/Solcast/Buzau_raw.csv", index=False)

def fetching_Horeco_data_15min():
	lat = 45.137111
	lon = 26.817112
	# Fetch data from the API
	api_url = "https://api.solcast.com.au/data/forecast/radiation_and_weather?latitude={}&longitude={}&hours=168&output_parameters=air_temp,ghi,azimuth,cloud_opacity,dewpoint_temp,relative_humidity,zenith&period=PT15M&format=csv&time_zone=3&api_key={}".format(lat, lon, solcast_api_key)
	...
	if response.status_code == 200:
		# Write the content to a CSV file
		with open("./Horeco/Solcast/Buzau_15min.csv", 'wb') as file:
			file.write(response.content)
	else:
		print(response.text)  # Add this line to see the error message returned by the API
		raise Exception(f"Failed to fetch data: Status code {response.status_code}")
	# Adjusting the values to EET time
	data = pd.read_csv("./Horeco/Solcast/Buzau_15min.csv")

def fetching_3D_Steel_data():
	lat = 44.760781
	lon = 26.003947
	# Fetch data from the API
	api_url = "https://api.solcast.com.au/data/forecast/radiation_and_weather?latitude={}&longitude={}&hours=168&output_parameters=air_temp,ghi,azimuth,cloud_opacity,dewpoint_temp,relative_humidity,zenith&period=PT60M&format=csv&api_key={}".format(lat, lon, solcast_api_key)
	...
	if response.status_code == 200:
		# Write the content to a CSV file
		with open("./3D_Steel/Solcast/Prahova_raw.csv", 'wb') as file:
			file.write(response.content)
	else:
		print(response.text)  # Add this line to see the error message returned by the API
		raise Exception(f"Failed to fetch data: Status code {response.status_code}")
	# Adjusting the values to EET time
	data = pd.read_csv("./3D_Steel/Solcast/Prahova_raw.csv")
	...
	# Save the adjusted DataFrame
	data_adjusted.to_csv("./3D_Steel/Solcast/Prahova_raw.csv", index=False)

def fetching_3D_Steel_data_15min():
	lat = 44.760781
	lon = 26.003947
	# Fetch data from the API
	api_url = "https://api.solcast.com.au/data/forecast/radiation_and_weather?latitude={}&longitude={}&hours=168&output_parameters=air_temp,ghi,azimuth,cloud_opacity,dewpoint_temp,relative_humidity,zenith&period=PT15M&format=csv&time_zone=3&api_key={}".format(lat, lon, solcast_api_key)
	...
	if response.status_code == 200:
		# Write the content to a CSV file
		with open("./3D_Steel/Solcast/Prahova_15min.csv", 'wb') as file:
			file.write(response.content)
	else:
		print(response.text)  # Add this line to see the error message returned by the API
		raise Exception(f"Failed to fetch data: Status code {response.status_code}")
	# Adjusting the values to EET time
	data = pd.read_csv("./3D_Steel/Solcast/Prahova_15min.csv")

def fetching_Dragosel_data():
	lat = 46.207512
	lon = 24.655984
	# Fetch data from the API
	api_url = "https://api.solcast.com.au/data/forecast/radiation_and_weather?latitude={}&longitude={}&hours=168&output_parameters=air_temp,ghi,azimuth,cloud_opacity,dewpoint_temp,relative_humidity,zenith&period=PT60M&format=csv&api_key={}".format(lat, lon, solcast_api_key)
	...
	if response.status_code == 200:
		# Write the content to a CSV file
		with open("./Dragosel/Solcast/Dragosel_raw.csv", 'wb') as file:
			file.write(response.content)
	else:
		print(response.text)  # Add this line to see the error message returned by the API
		raise Exception(f"Failed to fetch data: Status code {response.status_code}")
	# Adjusting the values to EET time
	data = pd.read_csv("./Dragosel/Solcast/Dragosel_raw.csv")
	...
	# Save the adjusted DataFrame
	data_adjusted.to_csv("./Dragosel/Solcast/Dragosel_raw.csv", index=False)

def fetching_Dragosel_data_15min():
	lat = 46.207512
	lon = 24.655984
	# Fetch data from the API
	api_url = "https://api.solcast.com.au/data/forecast/radiation_and_weather?latitude={}&longitude={}&hours=168&output_parameters=air_temp,ghi,azimuth,cloud_opacity,dewpoint_temp,relative_humidity,zenith&period=PT15M&format=csv&time_zone=3&api_key={}".format(lat, lon, solcast_api_key)
	...
	if response.status_code == 200:
		# Write the content to a CSV file
		with open("./Dragosel/Solcast/Dragosel_15min.csv", 'wb') as file:
			file.write(response.content)
	else:
		print(response.text)  # Add this line to see the error message returned by the API
		raise Exception(f"Failed to fetch data: Status code {response.status_code}")
	# Adjusting the values to EET time
	data = pd.read_csv("./Dragosel/Solcast/Dragosel_15min.csv")

def fetching_GESS_data_15min():
	lat = 44.563374
	lon = 25.764021
	# Fetch data from the API
	api_url = "https://api.solcast.com.au/data/forecast/radiation_and_weather?latitude={}&longitude={}&hours=168&output_parameters=air_temp,ghi,azimuth,cloud_opacity,dewpoint_temp,relative_humidity,zenith&period=PT15M&format=csv&time_zone=3&api_key={}".format(lat, lon, solcast_api_key)
	...
	if response.status_code == 200:
		# Write the content to a CSV file
		with open("./GESS/Solcast/Brezoaia_15min.csv", 'wb') as file:
			file.write(response.content)
	else:
		print(response.text)  # Add this line to see the error message returned by the API
		raise Exception(f"Failed to fetch data: Status code {response.status_code}")
...
def fetching_Necaluxan_data_15min():
	lat = 45.117846
	lon = 23.876344
	# Fetch data from the API
	api_url = "https://api.solcast.com.au/data/forecast/radiation_and_weather?latitude={}&longitude={}&hours=168&output_parameters=air_temp,ghi,azimuth,cloud_opacity,dewpoint_temp,relative_humidity,zenith&period=PT15M&format=csv&time_zone=3&api_key={}".format(lat, lon, solcast_api_key)
	...
	if response.status_code == 200:
		# Write the content to a CSV file
		with open("./Necaluxan/Solcast/Salcioara_15min.csv", 'wb') as file:
			file.write(response.content)
	else:
		print(response.text)  # Add this line to see the error message returned by the API
		raise Exception(f"Failed to fetch data: Status code {response.status_code}")
	# Adjusting the values to EET time
	data = pd.read_csv("./Necaluxan/Solcast/Salcioara_15min.csv")

def fetching_Adrem_data_15min():
	lat = 46.130809
	lon = 24.817104
	# Fetch data from the API
	api_url = "https://api.solcast.com.au/data/forecast/radiation_and_weather?latitude={}&longitude={}&hours=168&output_parameters=air_temp,ghi,azimuth,cloud_opacity,dewpoint_temp,relative_humidity,zenith&period=PT15M&format=csv&time_zone=3&api_key={}".format(lat, lon, solcast_api_key)
	...
	if response.status_code == 200:
		# Write the content to a CSV file
		with open("./Adrem/Solcast/Apold_15min.csv", 'wb') as file:
			file.write(response.content)
	else:
		print(response.text)  # Add this line to see the error message returned by the API
		raise Exception(f"Failed to fetch data: Status code {response.status_code}")
	# Adjusting the values to EET time
	data = pd.read_csv("./Adrem/Solcast/Apold_15min.csv")

def fetching_Motif_data_15min():
	lat = 47.847223
	lon = 26.332368
	# Fetch data from the API
	api_url = "https://api.solcast.com.au/data/forecast/radiation_and_weather?latitude={}&longitude={}&hours=168&output_parameters=air_temp,ghi,azimuth,cloud_opacity,dewpoint_temp,relative_humidity,zenith&period=PT15M&format=csv&time_zone=3&api_key={}".format(lat, lon, solcast_api_key)
	...
	if response.status_code == 200:
		# Write the content to a CSV file
		with open("./Motif/Solcast/Varfu_Campului_15min.csv", 'wb') as file:
			file.write(response.content)
	else:
		print(response.text)  # Add this line to see the error message returned by the API
		raise Exception(f"Failed to fetch data: Status code {response.status_code}")
	# Adjusting the values to EET time
	data = pd.read_csv("./Motif/Solcast/Varfu_Campului_15min.csv")

def fetching_Ferma_data_15min():
	lat = 44.614382
	lon = 26.749391
	# Fetch data from the API
	api_url = "https://api.solcast.com.au/data/forecast/radiation_and_weather?latitude={}&longitude={}&hours=168&output_parameters=air_temp,ghi,azimuth,cloud_opacity,dewpoint_temp,relative_humidity,zenith&period=PT15M&format=csv&time_zone=3&api_key={}".format(lat, lon, solcast_api_key)
	...
	if response.status_code == 200:
		# Write the content to a CSV file
		with open("./Ferma/Solcast/Axintele_15min.csv", 'wb') as file:
			file.write(response.content)
	else:
		print(response.text)  # Add this line to see the error message returned by the API
		raise Exception(f"Failed to fetch data: Status code {response.status_code}")
	# Adjusting the values to EET time
	data = pd.read_csv("./Ferma/Solcast/Axintele_15min.csv")

def fetching_HNG_data_15min():
	lat = 46.55699
	lon = 24.672321
	# Fetch data from the API
	api_url = "https://api.solcast.com.au/data/forecast/radiation_and_weather?latitude={}&longitude={}&hours=168&output_parameters=air_temp,ghi,azimuth,cloud_opacity,dewpoint_temp,relative_humidity,zenith&period=PT15M&format=csv&time_zone=3&api_key={}".format(lat, lon, solcast_api_key)
	...
	if response.status_code == 200:
		# Write the content to a CSV file
		with open("./HNG/Solcast/Mures_15min.csv", 'wb') as file:
			file.write(response.content)
	else:
		print(response.text)  # Add this line to see the error message returned by the API
		raise Exception(f"Failed to fetch data: Status code {response.status_code}")
	# Adjusting the values to EET time
	data = pd.read_csv("./HNG/Solcast/Mures_15min.csv")

def fetching_Sun_Grow_Lucia_data_15min():
	lat = 45.634809
	lon = 25.418103
	# Fetch data from the API
	api_url = "https://api.solcast.com.au/data/forecast/radiation_and_weather?latitude={}&longitude={}&hours=168&output_parameters=air_temp,ghi,azimuth,cloud_opacity,dewpoint_temp,relative_humidity,zenith&period=PT15M&format=csv&time_zone=3&api_key={}".format(lat, lon, solcast_api_key)
	...
	if response.status_code == 200:
		# Write the content to a CSV file
		with open("./Sun_Grow_Lucia/Solcast/Vulcan_15min.csv", 'wb') as file:
			file.write(response.content)
	else:
		print(response.text)  # Add this line to see the error message returned by the API
		raise Exception(f"Failed to fetch data: Status code {response.status_code}")
	# Adjusting the values to EET time
	data = pd.read_csv("./Sun_Grow_Lucia/Solcast/Vulcan_15min.csv")

def fetching_Photovoltaic_Energy_Project_data_15min():
	lat = 44.624012
	lon = 25.742809
	# Fetch data from the API
	api_url = "https://api.solcast.com.au/data/forecast/radiation_and_weather?latitude={}&longitude={}&hours=168&output_parameters=air_temp,ghi,azimuth,cloud_opacity,dewpoint_temp,relative_humidity,zenith&period=PT15M&format=csv&time_zone=3&api_key={}".format(lat, lon, solcast_api_key)
	...
	if response.status_code == 200:
		# Write the content to a CSV file
		with open("./Photovoltaic_Energy_Project/Solcast/Racari_15min.csv", 'wb') as file:
			file.write(response.content)
	else:
		print(response.text)  # Add this line to see the error message returned by the API
		raise Exception(f"Failed to fetch data: Status code {response.status_code}")
	# Adjusting the values to EET time
	data = pd.read_csv("./Photovoltaic_Energy_Project/Solcast/Racari_15min.csv")

def fetching_MM_MV_data_15min():
	lat = 46.771093
	lon = 24.700762
	# Fetch data from the API
	api_url = "https://api.solcast.com.au/data/forecast/radiation_and_weather?latitude={}&longitude={}&hours=168&output_parameters=air_temp,ghi,azimuth,cloud_opacity,dewpoint_temp,relative_humidity,zenith&period=PT15M&format=csv&time_zone=3&api_key={}".format(lat, lon, solcast_api_key)
	...
	if response.status_code == 200:
		# Write the content to a CSV file
		with open("./MM_MV/Solcast/Reghin_15min.csv", 'wb') as file:
			file.write(response.content)
	else:
		print(response.text)  # Add this line to see the error message returned by the API
		raise Exception(f"Failed to fetch data: Status code {response.status_code}")
...
def fetching_GCSP_data_15min(output_path="./GCSP/Solcast/Nusfalau_15min.csv"):
	lat = 47.199625
	lon = 22.709948
	api_url = "https://api.solcast.com.au/data/forecast/radiation_and_weather?latitude={}&longitude={}&hours=168&output_parameters=air_temp,ghi,azimuth,cloud_opacity,dewpoint_temp,relative_humidity,zenith&period=PT15M&format=csv&time_zone=3&api_key={}".format(lat, lon, solcast_api_key)
	response = requests.get(api_url)
...
def fetching_Rosiori_data_15min():
	...
	if response.status_code == 200:
		# Write the content to a CSV file
		with open("./Rosiori/Solcast/Rosiori_15min.csv", 'wb') as file:
			file.write(response.content)
	else:
		print(response.text)  # Add this line to see the error message returned by the API
		raise Exception(f"Failed to fetch data: Status code {response.status_code}")
	# Adjusting the values to EET time
	data = pd.read_csv("./Rosiori/Solcast/Rosiori_15min.csv")

def fetching_Anto_data_15min():
	lat = 47.081885
	lon = 22.205028
	# Fetch data from the API
	api_url = "https://api.solcast.com.au/data/forecast/radiation_and_weather?latitude={}&longitude={}&hours=168&output_parameters=air_temp,ghi,azimuth,cloud_opacity,dewpoint_temp,relative_humidity,zenith&period=PT15M&format=csv&time_zone=3&api_key={}".format(lat, lon, solcast_api_key)
	...
	if response.status_code == 200:
		# Write the content to a CSV file
		with open("./Anto/Solcast/Uileacu_15min.csv", 'wb') as file:
			file.write(response.content)
	else:
		print(response.text)  # Add this line to see the error message returned by the API
		raise Exception(f"Failed to fetch data: Status code {response.status_code}")
	# Adjusting the values to EET time
	data = pd.read_csv("./Anto/Solcast/Uileacu_15min.csv")
...
def predicting_exporting_Astro_15min(interval_from, interval_to, limitation_percentage):
	...
	xgb_loaded = joblib.load("./Astro/rs_xgb_astro_prod_15min_0726.pkl")
...
def predicting_exporting_SunEnergy_15min(interval_from, interval_to, limitation_percentage):
	# Creating the forecast_dataset df
	df= pd.read_csv('./PC SunEnergy/Solcast/Oltenita_15min.csv')
	# Convert the 'period_end' column to datetime, handling errors
	df['period_end'] = pd.to_datetime(df['period_end'], errors='coerce', format='%Y-%m-%dT%H:%M:%SZ')
	...
	xgb_loaded = joblib.load("./PC SunEnergy/rs_xgb_PCSun_prod_15min_0126.pkl")
	...
	#Exporting Results to Excel
	workbook = xlsxwriter.Workbook("./PC SunEnergy/Results_Production_SunEnergy_xgb_15min.xlsx")
	worksheet = workbook.add_worksheet("Production_Predictions")
	date_format = workbook.add_format({'num_format':'dd.mm.yyyy'})
	# Define a format for cells with three decimal places
	decimal_format = workbook.add_format({'num_format': '0.000'})
	...
	# Formatting the Results file
	# Step 1: Open the Excel file
	file_path = "./PC SunEnergy/Results_Production_SunEnergy_xgb_15min.xlsx"
	workbook = load_workbook(filename=file_path)
	worksheet = workbook['Production_Predictions']  # Adjust the sheet name as necessary
...
def predicting_exporting_SunEnergy(interval_from, interval_to, limitation_percentage):
	# Creating the forecast_dataset df
	data = pd.read_csv("./PC SunEnergy/Solcast/Oltenita_raw.csv")
	forecast_dataset = pd.read_excel("./PC SunEnergy/Input_SunEnergy.xlsx", sheet_name="Forecast_Dataset")
	# Convert 'period_end' in santimbru to datetime
	data['period_end'] = pd.to_datetime(data['period_end'], errors='coerce')
	# Extract just the date part in the desired format (as strings)
	dates = data['period_end'].dt.strftime('%Y-%m-%d')
	...
	xgb_loaded = joblib.load("./PC SunEnergy/rs_xgb_PCSunEnergy_default_0425.pkl")
	...
	#Exporting Results to Excel
	workbook = xlsxwriter.Workbook("./PC SunEnergy/Results_Production_SunEnergy_xgb.xlsx")
	worksheet = workbook.add_worksheet("Production_Predictions")
	date_format = workbook.add_format({'num_format':'dd.mm.yyyy'})
	# Define a format for cells with three decimal places
	decimal_format = workbook.add_format({'num_format': '0.000'})
	...
	# Formatting the Results file
	# Step 1: Open the Excel file
	file_path = "./PC SunEnergy/Results_Production_SunEnergy_xgb.xlsx"
	workbook = load_workbook(filename=file_path)
	worksheet = workbook['Production_Predictions']  # Adjust the sheet name as necessary
...
def predicting_exporting_Elnet_15min(interval_from, interval_to, limitation_percentage):
	# Creating the forecast_dataset df
	df= pd.read_csv('./Elnet/Solcast/Bucsani_15min.csv')
	# Convert the 'period_end' column to datetime, handling errors
	df['period_end'] = pd.to_datetime(df['period_end'], errors='coerce', format='%Y-%m-%dT%H:%M:%SZ')
	...
	xgb_loaded = joblib.load("./Elnet/rs_xgb_elnet_prod_15min_0726.pkl")
	...
	#Exporting Results to Excel
	workbook = xlsxwriter.Workbook("./Elnet/Results_Production_Elnet_xgb_15min.xlsx")
	worksheet = workbook.add_worksheet("Production_Predictions")
	date_format = workbook.add_format({'num_format':'dd.mm.yyyy'})
	# Define a format for cells with three decimal places
	decimal_format = workbook.add_format({'num_format': '0.000'})
...
def predicting_exporting_Elnet(interval_from, interval_to, limitation_percentage):
	# Creating the forecast_dataset df
	data = pd.read_csv("./Elnet/Solcast/Bucsani_raw.csv")
	forecast_dataset = pd.read_excel("./Elnet/Input_Elnet.xlsx", sheet_name="Forecast_Dataset")
	# Convert 'period_end' in santimbru to datetime
	data['period_end'] = pd.to_datetime(data['period_end'], errors='coerce')
	# Extract just the date part in the desired format (as strings)
	dates = data['period_end'].dt.strftime('%Y-%m-%d')
	...
	xgb_loaded = joblib.load("./Elnet/rs_xgb_Elnet_default_0825.pkl")
	...
	#Exporting Results to Excel
	workbook = xlsxwriter.Workbook("./Elnet/Results_Production_Elnet_xgb.xlsx")
	worksheet = workbook.add_worksheet("Production_Predictions")
	date_format = workbook.add_format({'num_format':'dd.mm.yyyy'})
	# Define a format for cells with three decimal places
	decimal_format = workbook.add_format({'num_format': '0.000'})
...
def predicting_exporting_Horeco_15min(interval_from, interval_to, limitation_percentage):
	# Creating the forecast_dataset df
	df= pd.read_csv('./Horeco/Solcast/Buzau_15min.csv')
	# Convert the 'period_end' column to datetime, handling errors
	df['period_end'] = pd.to_datetime(df['period_end'], errors='coerce', format='%Y-%m-%dT%H:%M:%SZ')
	...
	xgb_loaded = joblib.load("./Horeco/rs_xgb_horeco_prod_15min_0726.pkl")
	...
	#Exporting Results to Excel
	workbook = xlsxwriter.Workbook("./Horeco/Results_Production_Horeco_xgb_15min.xlsx")
	worksheet = workbook.add_worksheet("Production_Predictions")
	date_format = workbook.add_format({'num_format':'dd.mm.yyyy'})
	# Define a format for cells with three decimal places
	decimal_format = workbook.add_format({'num_format': '0.000'})
...
def predicting_exporting_Horeco(interval_from, interval_to, limitation_percentage):
	# Creating the forecast_dataset df
	data = pd.read_csv("./Horeco/Solcast/Buzau_raw.csv")
	forecast_dataset = pd.read_excel("./Horeco/Input_Horeco.xlsx", sheet_name="Forecast_Dataset")
	# Convert 'period_end' in santimbru to datetime
	data['period_end'] = pd.to_datetime(data['period_end'], errors='coerce')
	# Extract just the date part in the desired format (as strings)
	dates = data['period_end'].dt.strftime('%Y-%m-%d')
	...
	xgb_loaded = joblib.load("./Horeco/rs_xgb_Horeco_default_0325.pkl")
	...
	#Exporting Results to Excel
	workbook = xlsxwriter.Workbook("./Horeco/Results_Production_Horeco_xgb.xlsx")
	worksheet = workbook.add_worksheet("Production_Predictions")
	date_format = workbook.add_format({'num_format':'dd.mm.yyyy'})
	# Define a format for cells with three decimal places
	decimal_format = workbook.add_format({'num_format': '0.000'})
...
def predicting_exporting_3D_Steel_15min(interval_from, interval_to, limitation_percentage):
	# Creating the forecast_dataset df
	df= pd.read_csv('./3D_Steel/Solcast/Prahova_15min.csv')
	# Convert the 'period_end' column to datetime, handling errors
	df['period_end'] = pd.to_datetime(df['period_end'], errors='coerce', format='%Y-%m-%dT%H:%M:%SZ')
	...
	#Exporting Results to Excel
	workbook = xlsxwriter.Workbook("./3D_Steel/Results_Production_3D_Steel_xgb_15min.xlsx")
	worksheet = workbook.add_worksheet("Production_Predictions")
	date_format = workbook.add_format({'num_format':'dd.mm.yyyy'})
	# Define a format for cells with three decimal places
	decimal_format = workbook.add_format({'num_format': '0.000'})
	...
	# Formatting the Results file
	# Step 1: Open the Excel file
	file_path = "./3D_Steel/Results_Production_3D_Steel_xgb_15min.xlsx"
	workbook = load_workbook(filename=file_path)
	worksheet = workbook['Production_Predictions']  # Adjust the sheet name as necessary
...
def predicting_exporting_3D_Steel(interval_from, interval_to, limitation_percentage):
	# Creating the forecast_dataset df
	data = pd.read_csv("./3D_Steel/Solcast/Prahova_raw.csv")
	forecast_dataset = pd.read_excel("./3D_Steel/Input_3D_Steel.xlsx", sheet_name="Forecast_Dataset")
	# Convert 'period_end' in santimbru to datetime
	data['period_end'] = pd.to_datetime(data['period_end'], errors='coerce')
	# Extract just the date part in the desired format (as strings)
	dates = data['period_end'].dt.strftime('%Y-%m-%d')
	...
	xgb_loaded = joblib.load("./3D_Steel/rs_xgb_3D_Steel_default_0825.pkl")
	...
	#Exporting Results to Excel
	workbook = xlsxwriter.Workbook("./3D_Steel/Results_Production_3D_Steel_xgb.xlsx")
	worksheet = workbook.add_worksheet("Production_Predictions")
	date_format = workbook.add_format({'num_format':'dd.mm.yyyy'})
	# Define a format for cells with three decimal places
	decimal_format = workbook.add_format({'num_format': '0.000'})
	...
	# Formatting the Results file
	# Step 1: Open the Excel file
	file_path = "./3D_Steel/Results_Production_3D_Steel_xgb.xlsx"
	workbook = load_workbook(filename=file_path)
	worksheet = workbook['Production_Predictions']  # Adjust the sheet name as necessary
...
def predicting_exporting_Dragosel_15min(interval_from, interval_to, limitation_percentage):
	# Creating the forecast_dataset df
	df= pd.read_csv('./Dragosel/Solcast/Dragosel_15min.csv')
	# Convert the 'period_end' column to datetime, handling errors
	df['period_end'] = pd.to_datetime(df['period_end'], errors='coerce', format='%Y-%m-%dT%H:%M:%SZ')
	...
	xgb_loaded = joblib.load("./Dragosel/rs_xgb_laslea_prod_15min_0626.pkl")
	...
	#Exporting Results to Excel
	workbook = xlsxwriter.Workbook("./Dragosel/Results_Production_Dragosel_xgb_15min.xlsx")
	worksheet = workbook.add_worksheet("Production_Predictions")
	date_format = workbook.add_format({'num_format':'dd.mm.yyyy'})
	# Define a format for cells with three decimal places
	decimal_format = workbook.add_format({'num_format': '0.000'})
...
def predicting_exporting_Dragosel(interval_from, interval_to, limitation_percentage):
	# Creating the forecast_dataset df
	data = pd.read_csv("./Dragosel/Solcast/Dragosel_raw.csv")
	forecast_dataset = pd.read_excel("./Dragosel/Input_Dragosel.xlsx", sheet_name="Forecast_Dataset")
	# Convert 'period_end' in santimbru to datetime
	data['period_end'] = pd.to_datetime(data['period_end'], errors='coerce')
	# Extract just the date part in the desired format (as strings)
	dates = data['period_end'].dt.strftime('%Y-%m-%d')
	...
	xgb_loaded = joblib.load("./Dragosel/rs_xgb_Dragosel_default_0625.pkl")
	...
	#Exporting Results to Excel
	workbook = xlsxwriter.Workbook("./Dragosel/Results_Production_Dragosel_xgb.xlsx")
	worksheet = workbook.add_worksheet("Production_Predictions")
	date_format = workbook.add_format({'num_format':'dd.mm.yyyy'})
	# Define a format for cells with three decimal places
	decimal_format = workbook.add_format({'num_format': '0.000'})
...
def predicting_exporting_GESS_15min(interval_from, interval_to, limitation_percentage):
	# Creating the forecast_dataset df
	df= pd.read_csv('./GESS/Solcast/Brezoaia_15min.csv')
	# Convert the 'period_end' column to datetime, handling errors
	df['period_end'] = pd.to_datetime(df['period_end'], errors='coerce', format='%Y-%m-%dT%H:%M:%SZ')
	...
	xgb_loaded = joblib.load("./GESS/rs_xgb_gess_prod_15min_0726.pkl")
	...
	#Exporting Results to Excel
	workbook = xlsxwriter.Workbook("./GESS/Results_Production_GESS_xgb_15min.xlsx")
	worksheet = workbook.add_worksheet("Production_Predictions")
	date_format = workbook.add_format({'num_format':'dd.mm.yyyy'})
	# Define a format for cells with three decimal places
	decimal_format = workbook.add_format({'num_format': '0.000'})
	...
	# Formatting the Results file
	# Step 1: Open the Excel file
	file_path = "./GESS/Results_Production_GESS_xgb_15min.xlsx"
	workbook = load_workbook(filename=file_path)
	worksheet = workbook['Production_Predictions']  # Adjust the sheet name as necessary
...
def predicting_exporting_NRG_15min(interval_from, interval_to, limitation_percentage):
	...
	xgb_loaded = joblib.load("./NRG/rs_xgb_nrg_prod_15min_0326.pkl")
...
def predicting_exporting_Sun_Grow_Lucia_15min(interval_from, interval_to, limitation_percentage):
	# Creating the forecast_dataset df
	df= pd.read_csv('./Sun_Grow_Lucia/Solcast/Vulcan_15min.csv')
	# Convert the 'period_end' column to datetime, handling errors
	df['period_end'] = pd.to_datetime(df['period_end'], errors='coerce', format='%Y-%m-%dT%H:%M:%SZ')
...
def predicting_exporting_Photovoltaic_Energy_Project_15min(interval_from, interval_to, limitation_percentage):
	# Creating the forecast_dataset df
	df= pd.read_csv('./Photovoltaic_Energy_Project/Solcast/Racari_15min.csv')
	# Convert the 'period_end' column to datetime, handling errors
	df['period_end'] = pd.to_datetime(df['period_end'], errors='coerce', format='%Y-%m-%dT%H:%M:%SZ')
	...
	xgb_loaded = joblib.load("./Photovoltaic_Energy_Project/rs_xgb_PEP_prod_15min_0126.pkl")
	...
	#Exporting Results to Excel
	workbook = xlsxwriter.Workbook("./Photovoltaic_Energy_Project/Results_Production_Photovoltaic_Energy_Project_xgb_15min.xlsx")
	worksheet = workbook.add_worksheet("Production_Predictions")
	date_format = workbook.add_format({'num_format':'dd.mm.yyyy'})	
	# Define a format for cells with three decimal places
	decimal_format = workbook.add_format({'num_format': '0.000'})
...
def predicting_exporting_MM_MV_15min(interval_from, interval_to, limitation_percentage):
	# Creating the forecast_dataset df
	df= pd.read_csv('./MM_MV/Solcast/Reghin_15min.csv')
	# Convert the 'period_end' column to datetime, handling errors
	df['period_end'] = pd.to_datetime(df['period_end'], errors='coerce', format='%Y-%m-%dT%H:%M:%SZ')
	...
	xgb_loaded = joblib.load("./MM_MV/rs_xgb_mm&mv_prod_15min_0726.pkl")
	...
	#Exporting Results to Excel
	workbook = xlsxwriter.Workbook("./MM_MV/Results_Production_MM_MV_xgb_15min.xlsx")
	worksheet = workbook.add_worksheet("Production_Predictions")
	date_format = workbook.add_format({'num_format':'dd.mm.yyyy'})	
	# Define a format for cells with three decimal places
	decimal_format = workbook.add_format({'num_format': '0.000'})
...
def predicting_exporting_GCSP_15min(
	interval_from,
	interval_to,
	limitation_percentage,
	weather_path="./GCSP/Solcast/Nusfalau_15min.csv",
	model_path="./GCSP/rs_xgb_gcsp_prod_15min_0726.pkl",
	output_path="./GCSP/Results_Production_GCSP_xgb_15min.xlsx",
):
	df = pd.read_csv(weather_path)
	required_columns = {"period_end", "air_temp", "cloud_opacity", "ghi"}
	missing_columns = sorted(required_columns - set(df.columns))
	if missing_columns:
		raise ValueError(
			"GCSP weather data is missing columns: " + ", ".join(missing_columns)
		)
	...
	if period_end.isna().any():
		raise ValueError("GCSP weather data contains invalid period_end values.")
	df["Data"] = (
		period_end.dt.tz_convert("Europe/Bucharest").dt.tz_localize(None)
	)
	df["Interval"] = df.Data.dt.hour * 4 + df.Data.dt.minute // 15 + 1
	...
	forecast_dataset = df[feature_columns]
	if not np.isfinite(forecast_dataset.to_numpy(dtype=float)).all():
		raise ValueError("GCSP forecast features contain NaN or infinite values.")

	model = joblib.load(model_path)
	if int(getattr(model, "n_features_in_", len(feature_columns))) != len(feature_columns):
		raise ValueError("GCSP model does not match the expected six input features.")
	predictions = np.asarray(model.predict(forecast_dataset.values), dtype=float)
	if predictions.shape != (len(df),) or not np.isfinite(predictions).all():
		raise ValueError("GCSP model returned invalid predictions.")
	predictions = np.maximum(predictions, 0)
	predictions[df["is_dark"].to_numpy(dtype=bool)] = 0
	limited = df["Interval"].between(interval_from * 4, interval_to * 4)
	predictions[limited] *= 1 - limitation_percentage / 100
...
def predicting_exporting_Rosiori_15min(interval_from, interval_to, limitation_percentage):
	# Creating the forecast_dataset df
	df= pd.read_csv('./Rosiori/Solcast/Rosiori_15min.csv')
	# Convert the 'period_end' column to datetime, handling errors
	df['period_end'] = pd.to_datetime(df['period_end'], errors='coerce', format='%Y-%m-%dT%H:%M:%SZ')
	...
	xgb_loaded = joblib.load("./Rosiori/rs_xgb_rosiori_prod_15min_0726.pkl")
	...
	#Exporting Results to Excel
	workbook = xlsxwriter.Workbook("./Rosiori/Results_Production_Rosiori_xgb_15min.xlsx")
	worksheet = workbook.add_worksheet("Production_Predictions")
	date_format = workbook.add_format({'num_format':'dd.mm.yyyy'})	
	# Define a format for cells with three decimal places
	decimal_format = workbook.add_format({'num_format': '0.000'})
...
def predicting_exporting_Necaluxan_15min(interval_from, interval_to, limitation_percentage):
	# Creating the forecast_dataset df
	df= pd.read_csv('./Necaluxan/Solcast/Salcioara_15min.csv')
	# Convert the 'period_end' column to datetime, handling errors
	df['period_end'] = pd.to_datetime(df['period_end'], errors='coerce', format='%Y-%m-%dT%H:%M:%SZ')
	...
	xgb_loaded = joblib.load("./Necaluxan/rs_xgb_necaluxan_prod_15min_0826.pkl")
	...
	#Exporting Results to Excel
	workbook = xlsxwriter.Workbook("./Necaluxan/Results_Production_Necaluxan_xgb_15min.xlsx")
	worksheet = workbook.add_worksheet("Production_Predictions")
	date_format = workbook.add_format({'num_format':'dd.mm.yyyy'})	
	# Define a format for cells with three decimal places
	decimal_format = workbook.add_format({'num_format': '0.000'})
...
def predicting_exporting_Adrem_15min(interval_from, interval_to, limitation_percentage):
	# Creating the forecast_dataset df
	df= pd.read_csv('./Adrem/Solcast/Apold_15min.csv')
	# Convert the 'period_end' column to datetime, handling errors
	df['period_end'] = pd.to_datetime(df['period_end'], errors='coerce', format='%Y-%m-%dT%H:%M:%SZ')
	...
	xgb_loaded = joblib.load("./Adrem/rs_xgb_adrem_prod_15min_0826.pkl")
	...
	#Exporting Results to Excel
	workbook = xlsxwriter.Workbook("./Adrem/Results_Production_Adrem_xgb_15min.xlsx")
	worksheet = workbook.add_worksheet("Production_Predictions")
	date_format = workbook.add_format({'num_format':'dd.mm.yyyy'})	
	# Define a format for cells with three decimal places
	decimal_format = workbook.add_format({'num_format': '0.000'})
...
def predicting_exporting_Anto_15min(interval_from, interval_to, limitation_percentage):
	# Creating the forecast_dataset df
	df= pd.read_csv('./Anto/Solcast/Uileacu_15min.csv')
	# Convert the 'period_end' column to datetime, handling errors
	df['period_end'] = pd.to_datetime(df['period_end'], errors='coerce', format='%Y-%m-%dT%H:%M:%SZ')
	...
	xgb_loaded = joblib.load("./Anto/rs_xgb_anto_prod_15min_0826.pkl")
	...
	#Exporting Results to Excel
	workbook = xlsxwriter.Workbook("./Anto/Results_Production_Anto_xgb_15min.xlsx")
	worksheet = workbook.add_worksheet("Production_Predictions")
	date_format = workbook.add_format({'num_format':'dd.mm.yyyy'})	
	# Define a format for cells with three decimal places
	decimal_format = workbook.add_format({'num_format': '0.000'})
...
def predicting_exporting_Motif_15min(interval_from, interval_to, limitation_percentage):
	# Creating the forecast_dataset df
	df= pd.read_csv('./Motif/Solcast/Varfu_Campului_15min.csv')
	# Convert the 'period_end' column to datetime, handling errors
	df['period_end'] = pd.to_datetime(df['period_end'], errors='coerce', format='%Y-%m-%dT%H:%M:%SZ')
	...
	xgb_loaded = joblib.load("./Motif/rs_xgb_motif_prod_15min_0726.pkl")
	...
	#Exporting Results to Excel
	workbook = xlsxwriter.Workbook("./Motif/Results_Production_Motif_xgb_15min.xlsx")
	worksheet = workbook.add_worksheet("Production_Predictions")
	date_format = workbook.add_format({'num_format':'dd.mm.yyyy'})	
	# Define a format for cells with three decimal places
	decimal_format = workbook.add_format({'num_format': '0.000'})
...
def predicting_exporting_HNG_15min(interval_from, interval_to, limitation_percentage):
	# Creating the forecast_dataset df
	df= pd.read_csv('./HNG/Solcast/Mures_15min.csv')
	# Convert the 'period_end' column to datetime, handling errors
	df['period_end'] = pd.to_datetime(df['period_end'], errors='coerce', format='%Y-%m-%dT%H:%M:%SZ')
	...
	xgb_loaded = joblib.load("./HNG/rs_xgb_hng_prod_15min_0826.pkl")
	...
	#Exporting Results to Excel
	workbook = xlsxwriter.Workbook("./HNG/Results_Production_HNG_xgb_15min.xlsx")
	worksheet = workbook.add_worksheet("Production_Predictions")
	date_format = workbook.add_format({'num_format':'dd.mm.yyyy'})	
	# Define a format for cells with three decimal places
	decimal_format = workbook.add_format({'num_format': '0.000'})
...
def predicting_exporting_Ferma_15min(interval_from, interval_to, limitation_percentage):
	# Creating the forecast_dataset df
	df= pd.read_csv('./Ferma/Solcast/Axintele_15min.csv')
	# Convert the 'period_end' column to datetime, handling errors
	df['period_end'] = pd.to_datetime(df['period_end'], errors='coerce', format='%Y-%m-%dT%H:%M:%SZ')
	...
	xgb_loaded = joblib.load("./Ferma/rs_xgb_ferma_prod_15min_0826.pkl")
	...
	#Exporting Results to Excel
	workbook = xlsxwriter.Workbook("./Ferma/Results_Production_Ferma_xgb_15min.xlsx")
	worksheet = workbook.add_worksheet("Production_Predictions")
	date_format = workbook.add_format({'num_format':'dd.mm.yyyy'})	
	# Define a format for cells with three decimal places
	decimal_format = workbook.add_format({'num_format': '0.000'})
...
def render_production_forecast():
	...
	# Allow the user to choose between Consumption and Production
	PVPP = st.radio("Choose PVPP:", options=["Kahraman", "Astro", "Imperial", "SunEnergy", "SolarEnergy", "Elnet", "Horeco", "3D Steel", "Dragosel", "GESS", "NRG", "Sun Grow Lucia", "Photovoltaic Energy Project", "MM_MV", "Primaria Rosiori", "Necaluxan", "Adrem", "Anto", "Motif", "Ferma", "HNG"], index=None)
	...
	if PVPP == "Kahraman":
		...
		if st.button("Submit"):
			...
			with open(file_path, "rb") as f:
				...
				b64 = base64.b64encode(excel_data).decode()
				button_html = f"""
					 <a download="Production_Forecast_SunEnergy.xlsx" href="data:application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;base64,{b64}" download>
					 <button kind="secondary" data-testid="baseButton-secondary" class="st-emotion-cache-12tniow ef3psqc12">Download Forecast Results</button>
					 </a> 
					 """
				st.markdown(button_html, unsafe_allow_html=True)
		...
		if st.button("Submit"):
			...
			with open(file_path, "rb") as f:
				...
				b64 = base64.b64encode(excel_data).decode()
				button_html = f"""
					 <a download="Production_Forecast_Elnet.xlsx" href="data:application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;base64,{b64}" download>
					 <button kind="secondary" data-testid="baseButton-secondary" class="st-emotion-cache-12tniow ef3psqc12">Download Forecast Results</button>
					 </a> 
					 """
				st.markdown(button_html, unsafe_allow_html=True)
			...
			with open(file_path, "rb") as f:
				...
				b64 = base64.b64encode(excel_data).decode()
				button_html = f"""
					 <a download="Production_Forecast_Elnet_15min.xlsx" href="data:application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;base64,{b64}" download>
					 <button kind="secondary" data-testid="baseButton-secondary" class="st-emotion-cache-12tniow ef3psqc12">Download Forecast Results 15min</button>
					 </a> 
					 """
				st.markdown(button_html, unsafe_allow_html=True)
		...
		# Updating the indisponibility, if any
		result_Horeco = render_indisponibility_db_Horeco()
		if result_Horeco[0] is not None:
			interval_from, interval_to, limitation_percentage = result_Horeco
		else:
			# Handle the case where no data is found
			# st.text("No indisponibility found for tomorrow")
			# Fallback logic: Add your fallback actions here
		...
		if st.button("Submit"):
			...
			with open(file_path, "rb") as f:
				...
				b64 = base64.b64encode(excel_data).decode()
				button_html = f"""
					 <a download="Production_Forecast_Horeco.xlsx" href="data:application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;base64,{b64}" download>
					 <button kind="secondary" data-testid="baseButton-secondary" class="st-emotion-cache-12tniow ef3psqc12">Download Forecast Results</button>
					 </a> 
					 """
				st.markdown(button_html, unsafe_allow_html=True)
			...
			with open(file_path, "rb") as f:
				...
				b64 = base64.b64encode(excel_data).decode()
				button_html = f"""
					 <a download="Production_Forecast_Horeco_15min.xlsx" href="data:application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;base64,{b64}" download>
					 <button kind="secondary" data-testid="baseButton-secondary" class="st-emotion-cache-12tniow ef3psqc12">Download Forecast Results 15min</button>
					 </a> 
					 """
				st.markdown(button_html, unsafe_allow_html=True)
		...
		if st.button("Submit"):
			...
			with open(file_path, "rb") as f:
				...
				b64 = base64.b64encode(excel_data).decode()
				button_html = f"""
					 <a download="Production_Forecast_3D_Steel.xlsx" href="data:application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;base64,{b64}" download>
					 <button kind="secondary" data-testid="baseButton-secondary" class="st-emotion-cache-12tniow ef3psqc12">Download Forecast Results</button>
					 </a> 
					 """
				st.markdown(button_html, unsafe_allow_html=True)
			...
			with open(file_path, "rb") as f:
				...
				b64 = base64.b64encode(excel_data).decode()
				button_html = f"""
					 <a download="Production_Forecast_3D_Steel_15min.xlsx" href="data:application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;base64,{b64}" download>
					 <button kind="secondary" data-testid="baseButton-secondary" class="st-emotion-cache-12tniow ef3psqc12">Download Forecast Results 15min</button>
					 </a> 
					 """
				st.markdown(button_html, unsafe_allow_html=True)
		...
		# Updating the indisponibility, if any
		result_Dragosel = render_indisponibility_db_Dragosel()
		if result_Dragosel[0] is not None:
			interval_from, interval_to, limitation_percentage = result_Dragosel
		else:
			# Handle the case where no data is found
			# st.text("No indisponibility found for tomorrow")
			# Fallback logic: Add your fallback actions here
		...
		if st.button("Submit"):
			...
			with open(file_path, "rb") as f:
				...
				b64 = base64.b64encode(excel_data).decode()
				button_html = f"""
					 <a download="Production_Forecast_Dragosel.xlsx" href="data:application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;base64,{b64}" download>
					 <button kind="secondary" data-testid="baseButton-secondary" class="st-emotion-cache-12tniow ef3psqc12">Download Forecast Results</button>
					 </a> 
					 """
				st.markdown(button_html, unsafe_allow_html=True)
			...
			with open(file_path, "rb") as f:
				...
				b64 = base64.b64encode(excel_data).decode()
				button_html = f"""
					 <a download="Production_Forecast_Dragosel_15min.xlsx" href="data:application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;base64,{b64}" download>
					 <button kind="secondary" data-testid="baseButton-secondary" class="st-emotion-cache-12tniow ef3psqc12">Download Forecast Results 15min</button>
					 </a> 
					 """
				st.markdown(button_html, unsafe_allow_html=True)
		...
		# Updating the indisponibility, if any
		result_GESS = render_indisponibility_db_GESS()
		if result_GESS[0] is not None:
			interval_from, interval_to, limitation_percentage = result_GESS
		else:
			# Handle the case where no data is found
			# st.text("No indisponibility found for tomorrow")
			# Fallback logic: Add your fallback actions here
	...
	elif PVPP == "Sun Grow Lucia":
		# Updating the indisponibility, if any
		result_Sun_Grow_Lucia = render_indisponibility_db_Sun_Grow_Lucia()
		if result_Sun_Grow_Lucia[0] is not None:
			interval_from, interval_to, limitation_percentage = result_Sun_Grow_Lucia
		else:
			# Handle the case where no data is found
			# st.text("No indisponibility found for tomorrow")
			# Fallback logic: Add your fallback actions here
		...
		if st.button("Submit"):
			...
			with open(file_path, "rb") as f:
				...
				b64 = base64.b64encode(excel_data).decode()
				button_html = f"""
					 <a download="Production_Forecast_Sun_Grow_Lucia_15min.xlsx" href="data:application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;base64,{b64}" download>
					 <button kind="secondary" data-testid="baseButton-secondary" class="st-emotion-cache-12tniow ef3psqc12">Download Forecast Results 15min</button>
					 </a> 
					 """
				st.markdown(button_html, unsafe_allow_html=True)
	...
	elif PVPP == "Photovoltaic Energy Project":
		# Updating the indisponibility, if any
		...
		if st.button("Submit"):
			...
			with open(file_path, "rb") as f:
				...
				b64 = base64.b64encode(excel_data).decode()
				button_html = f"""
					 <a download="Production_Forecast_Photovoltaic_Energy_Project_15min.xlsx" href="data:application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;base64,{b64}" download>
					 <button kind="secondary" data-testid="baseButton-secondary" class="st-emotion-cache-12tniow ef3psqc12">Download Forecast Results 15min</button>
					 </a> 
					 """
				st.markdown(button_html, unsafe_allow_html=True)
		...
		if st.button("Submit"):
			...
			with open(file_path, "rb") as f:
				...
				b64 = base64.b64encode(excel_data).decode()
				button_html = f"""
					 <a download="Production_Forecast_MM_MV_15min.xlsx" href="data:application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;base64,{b64}" download>
					 <button kind="secondary" data-testid="baseButton-secondary" class="st-emotion-cache-12tniow ef3psqc12">Download Forecast Results 15min</button>
					 </a> 
					 """
				st.markdown(button_html, unsafe_allow_html=True)
		...
		if st.button("Submit"):
			...
			with open(file_path, "rb") as f:
				...
				b64 = base64.b64encode(excel_data).decode()
				button_html = f"""
					 <a download="Production_Forecast_Rosiori_15min.xlsx" href="data:application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;base64,{b64}" download>
					 <button kind="secondary" data-testid="baseButton-secondary" class="st-emotion-cache-12tniow ef3psqc12">Download Forecast Results 15min</button>
					 </a> 
					 """
				st.markdown(button_html, unsafe_allow_html=True)
		...
		# Updating the indisponibility, if any
		result_Necaluxan = render_indisponibility_db_Necaluxan()
		if result_Necaluxan[0] is not None:
			interval_from, interval_to, limitation_percentage = result_Necaluxan
		else:
			# Handle the case where no data is found
			# st.text("No indisponibility found for tomorrow")
			# Fallback logic: Add your fallback actions here
		...
		if st.button("Submit"):
			...
			with open(file_path, "rb") as f:
				...
				b64 = base64.b64encode(excel_data).decode()
				button_html = f"""
					 <a download="Production_Forecast_Necaluxan_15min.xlsx" href="data:application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;base64,{b64}" download>
					 <button kind="secondary" data-testid="baseButton-secondary" class="st-emotion-cache-12tniow ef3psqc12">Download Forecast Results 15min</button>
					 </a> 
					 """
				st.markdown(button_html, unsafe_allow_html=True)
		...
		# Updating the indisponibility, if any
		result_Adrem = render_indisponibility_db_Adrem()
		if result_Adrem[0] is not None:
			interval_from, interval_to, limitation_percentage = result_Adrem
		else:
			# Handle the case where no data is found
			# st.text("No indisponibility found for tomorrow")
			# Fallback logic: Add your fallback actions here
		...
		if st.button("Submit"):
			...
			with open(file_path, "rb") as f:
				...
				b64 = base64.b64encode(excel_data).decode()
				button_html = f"""
					 <a download="Production_Forecast_Adrem_15min.xlsx" href="data:application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;base64,{b64}" download>
					 <button kind="secondary" data-testid="baseButton-secondary" class="st-emotion-cache-12tniow ef3psqc12">Download Forecast Results 15min</button>
					 </a> 
					 """
				st.markdown(button_html, unsafe_allow_html=True)
		...
		# Updating the indisponibility, if any
		result_Anto = render_indisponibility_db_Anto()
		if result_Anto[0] is not None:
			interval_from, interval_to, limitation_percentage = result_Anto
		else:
			# Handle the case where no data is found
			# st.text("No indisponibility found for tomorrow")
			# Fallback logic: Add your fallback actions here
		...
		if st.button("Submit"):
			...
			with open(file_path, "rb") as f:
				...
				b64 = base64.b64encode(excel_data).decode()
				button_html = f"""
					 <a download="Production_Forecast_Anto_15min.xlsx" href="data:application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;base64,{b64}" download>
					 <button kind="secondary" data-testid="baseButton-secondary" class="st-emotion-cache-12tniow ef3psqc12">Download Forecast Results 15min</button>
					 </a> 
					 """
				st.markdown(button_html, unsafe_allow_html=True)
		...
		if st.button("Submit"):
			...
			with open(file_path, "rb") as f:
				...
				b64 = base64.b64encode(excel_data).decode()
				button_html = f"""
					 <a download="Production_Forecast_Motif_15min.xlsx" href="data:application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;base64,{b64}" download>
					 <button kind="secondary" data-testid="baseButton-secondary" class="st-emotion-cache-12tniow ef3psqc12">Download Forecast Results 15min</button>
					 </a> 
					 """
				st.markdown(button_html, unsafe_allow_html=True)
		...
		if result_Ferma[0] is not None:
			interval_from, interval_to, limitation_percentage = result_Ferma
		else:
			# Handle the case where no data is found
			# st.text("No indisponibility found for tomorrow")
			# Fallback logic: Add your fallback actions here
		...
		if st.button("Submit"):
			...
			with open(file_path, "rb") as f:
				...
				b64 = base64.b64encode(excel_data).decode()
				button_html = f"""
					 <a download="Production_Forecast_Ferma_15min.xlsx" href="data:application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;base64,{b64}" download>
					 <button kind="secondary" data-testid="baseButton-secondary" class="st-emotion-cache-12tniow ef3psqc12">Download Forecast Results 15min</button>
					 </a> 
					 """
				st.markdown(button_html, unsafe_allow_html=True)
		...
		# Updating the indisponibility, if any
		result_HNG = render_indisponibility_db_HNG()
		if result_HNG[0] is not None:
			interval_from, interval_to, limitation_percentage = result_HNG
		else:
			# Handle the case where no data is found
			# st.text("No indisponibility found for tomorrow")
			# Fallback logic: Add your fallback actions here
		...
		if st.button("Submit"):
			...
			with open(file_path, "rb") as f:
				...
				b64 = base64.b64encode(excel_data).decode()
				button_html = f"""
					 <a download="Production_Forecast_HNG_15min.xlsx" href="data:application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;base64,{b64}" download>
					 <button kind="secondary" data-testid="baseButton-secondary" class="st-emotion-cache-12tniow ef3psqc12">Download Forecast Results 15min</button>
					 </a> 
					 """
				st.markdown(button_html, unsafe_allow_html=True)
