...
def create_indisponibility_tables():
    ...
    if conn is not None:
        try:
            ...
            # Create indisponibility_anto table

            cursor.execute('''
                CREATE TABLE IF NOT EXISTS indisponibility_anto (
                    id SERIAL PRIMARY KEY,
                    type VARCHAR(255) NOT NULL,
                    start_date DATE NOT NULL,
                    end_date DATE NOT NULL,
            ...
            # Create indisponibility_motif table

            cursor.execute('''
                CREATE TABLE IF NOT EXISTS indisponibility_motif (
                    id SERIAL PRIMARY KEY,
                    type VARCHAR(255) NOT NULL,
                    start_date DATE NOT NULL,
                    end_date DATE NOT NULL,
            ...
            cursor.execute('''
                CREATE TABLE IF NOT EXISTS indisponibility_ferma (
                    id SERIAL PRIMARY KEY,
                    type VARCHAR(255) NOT NULL,
                    start_date DATE NOT NULL,
                    end_date DATE NOT NULL,
            ...
            # Create indisponibility_hng table

            cursor.execute('''
                CREATE TABLE IF NOT EXISTS indisponibility_hng (
                    id SERIAL PRIMARY KEY,
                    type VARCHAR(255) NOT NULL,
                    start_date DATE NOT NULL,
                    end_date DATE NOT NULL,
